...
<Meta title="Migration to Form Template" />

<Title>Form Template v0</Title>
...
1. New `RHF component` includes many features and enhance user control with them. Moreover, they provide us with a
   shorter syntax and easier to implement.
...
[Move to here](../modules/form-template/README.md#block)

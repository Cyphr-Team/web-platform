    ...
    >
      ...
      >
        ...
        <p>
          ...
          continue to be delivered electronically unless otherwise specified. As
          a mobile bank, Small Business Bank reserves the right to close your
        ...
        <p>
          ...
          traditional paper documents mailed to you. Electronic statements will
          be delivered to you electronically in Portable Document Format (“PDF”)
          that you can view online, save to your computer, or print at your
          convenience.
        </p>
        <p>
        ...
        <p>
          ...
          documents and communications by mail.We will not impose a fee to
          ...
          communications will be effective only after we have a reasonable time
          period to process your withdrawal.
        </p>
        <p>
          It is your responsibility to provide the Bank with accurate and
          complete contact information, including e-mail address, and any other
          information related to the accounts. You may update such information
          by contacting the Bank at the address or telephone number listed
          below:
        </p>
        <div>
        ...
        <p>
          ...
          you must have the following minimum hardware and software to access
          and retain the electronic document(s)
        </p>
        <p>
          ...
          encryption software: software permitting receipt and access to
          Portable Document Format files, such as the current Adobe Acrobat
          Reader. If the Bank changes the hardware or software requirements, the
          Bank will provide you with a statement of the revised hardware and
          software requirements.
        </p>
        <p>
          I request the Bank to provide me with the applicable communications,
          disclosures, advisories, documents, or periodic statements in
          electronic format. By checking the box below, I confirm that I meet,
          at a minimum, the hardware and software requirements listed above to
          receive and retain electronic disclosures, advisories, and documents.
        </p>

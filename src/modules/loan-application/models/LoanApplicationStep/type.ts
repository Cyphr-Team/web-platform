...
const STEP_MENU = Object.freeze({
  ...
  SIGNATURE: `${isLoanReady() ? "VERIFY" : "PREVIEW"} AND SIGN`
} as const)
...
interface ILoanApplicationStep {
  ...
  parent: (typeof STEP_MENU)[keyof typeof STEP_MENU]
  label: string

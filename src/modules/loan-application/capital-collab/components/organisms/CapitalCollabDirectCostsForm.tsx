...
import {
  capitalCollabDirectCostsFormSchema,
...
export function CapitalCollabDirectCostsForm() {
  const { directCosts, dispatchFormAction } = useLoanApplicationFormContext()

  const form = useForm<CapitalCollabDirectCostsFormValue>({
    resolver: zodResolver(capitalCollabDirectCostsFormSchema),
    mode: "onBlur",
...
interface DirectCostsProps {
  ...
  value: FieldArrayWithId<
    CapitalCollabDirectCostsFormValue["directCosts"][number]
  >
        ...
        <div className="col-start-1 col-end-3 row-start-1 flex flex-col gap-1">
          <RHFTextInput
            ...
            name={getArrayFieldName<
              DirectCostsField,
              FieldPath<CapitalCollabDirectCostsFormValue>

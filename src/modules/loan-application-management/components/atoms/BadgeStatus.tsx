...
export const BadgeStatus: React.FC<Props> = ({ status }) => {
  switch (status) {
    case KYC_STATUS.VERIFIED:
      return (
        <Badge className="space-x-xs py-xs px-md border w-fit h-fit bg-success-50 border-success-200">
    ...
    case KYC_STATUS.UNVERIFIED:
      return (
        <Badge className="space-x-xs py-xs px-md border w-fit h-fit bg-error-50 border-error-200">

...
export const CardStatus: React.FC<Props> = ({ status, amount = 0 }) => {
  switch (status) {
    case STATE_STATUS.ACTIVE:
      return (
        <div className="flex flex-col flex-1 p-xl gap-y-lg bg-success-100">
    ...
    case STATE_STATUS.INACTIVE:
      return (
        <div className="flex flex-col flex-1 p-xl gap-y-lg bg-warning-100">
    ...
    default:
      return (
        <div className="flex flex-col flex-1 p-xl gap-y-lg bg-gray-100">

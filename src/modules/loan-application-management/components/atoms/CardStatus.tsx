...
export const CardStatus: React.FC<Props> = ({ status, amount = 0 }) => {
  switch (status) {
    case STATE_STATUS.ACTIVE:
      return (
        <div className="flex flex-1 flex-col gap-y-lg bg-success-100 p-xl">
    ...
    case STATE_STATUS.INACTIVE:
      return (
        <div className="flex flex-1 flex-col gap-y-lg bg-warning-100 p-xl">
    ...
    default:
      return (
        <div className="flex flex-1 flex-col gap-y-lg bg-gray-100 p-xl">

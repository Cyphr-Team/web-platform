    ...
    <div className="flex-[2.25] bg-[#F2F8F8] rounded-[40px] border border-black shadow-[8px_8px_12px_0px_#052B1540]">
      ...
      <div className="flex flex-col gap-4 text-center p-8">
        {isLoading ? (
          ...
          <>
            <span className="text-[1.75rem] font-semibold capitalize">
              {category
...
const ApplicationScore: FC<ApplicationScoreProps> = ({
  ...
  return (
    <div className="bg-[#002615] flex relative overflow-hidden flex-[5] p-8 rounded-[2.5rem] shadow-[8px_8px_12px_0px_#052B1540] flex-wrap">
      <div className="w-[70%] h-full -translate-y-3/4 absolute bg-[#B3F00D] left-1/2 -translate-x-1/2 rounded-full blur-[184px]" />
      <div className="text-white mt-auto flex flex-col gap-6 mb-10">
